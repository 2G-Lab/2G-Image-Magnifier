...
class x2G_ImagesStyleSheet {
  constructor (StyleSheetURL) {
    ...
    //window.addEventListener('load',()=>{document.head.appendChild(this.link)});
    document.head.appendChild(this.link);
  }
}
new x2G_ImagesStyleSheet("https://cdn.jsdelivr.net/gh/2G-Lab/2G-Image-Magnifier/style.css");
